...
  const filteredProducts = nonVegProducts
    .filter((product) => {
      switch (priceFilter) {
        case "under-200":
...
  return (
    <div className="nonveg-bg">
      <div className="container-fluid py-5">
        <h1 className="text-center mb-4 main-heading">
          🍗 Savory Non-Veg Dishes 🍖
        </h1>
...
          >
            {nonVegProducts.slice(0, 5).map((product) => (
...
            <button
              className={`filter-btn ${
                priceFilter === "under-200" ? "active" : ""
              }`}
              onClick={() => {
                setPriceFilter("under-200");
                setCurrentPage(1);
              }}
            >
              Below ₹200
...
            <button
              className={`filter-btn ${
                priceFilter === "200-to-500" ? "active" : ""
              }`}
              onClick={() => {
                setPriceFilter("200-to-500");
                setCurrentPage(1);
              }}
            >
              ₹200 - ₹500
...
            <button
              className={`filter-btn ${
                priceFilter === "over-500" ? "active" : ""
              }`}
              onClick={() => {
                setPriceFilter("over-500");
                setCurrentPage(1);
              }}
            >
              Above ₹500
...
                    <h5 className="card-title">{product.name}</h5>
                    <p className="card-text">Delicious and freshly made.</p>
